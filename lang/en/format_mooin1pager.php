...
$string['plugin_description'] = 'The mooin1pager course format is an adaption of the mooin4 course format with all course elements displayed on one page, comparable to the topics format. The various mooin4-specific areas such as the news forum preview, certificates and badges tile and more can be found in their familiar places, the mooin4 design is adopted and thus enables other course concepts that visually match.';
